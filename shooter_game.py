...
win = font1.render('YOU CHEBYREK!', True, (255, 255, 255))
lose = font1.render('YOU NE CHEBYREK!', True, (180, 0, 0))
...
#фоновая музыка
mixer.init()
mixer.music.load('main-menu-2.mp3')
mixer.music.play()
...
class Player(GameSprite):
   # метод для управления спрайтом стрелками клавиатуры
    ...
    def fire(self):
        ...
        bullet1 = Bullet(img_bullet, self.rect.x, self.rect.y, 15, 20, -15)
        bullet2 = Bullet(img_bullet, self.rect.x+80, self.rect.top, 15, 20, -15)
        bullets.add(bullet)
        bullets.add(bullet1)
        bullets.add(bullet2)
